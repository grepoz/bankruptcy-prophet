...
if __name__ == '__main__':
    ...
    found_tickers_json_file_path = 'tickers.json'

    with open(found_tickers_json_file_path, 'r') as file:
        found_tickers = json.load(file)
    ...
    not_found_tickers_json_file_path = 'scrapping/tickers.json'

    with open(not_found_tickers_json_file_path, 'r') as file:
        not_found_tickers = json.load(file)

    print(f'Number of tickers: {len(tickers)}, not found tickers: {len(not_found_tickers)}')
